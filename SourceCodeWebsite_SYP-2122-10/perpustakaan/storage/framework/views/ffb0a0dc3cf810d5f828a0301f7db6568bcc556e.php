<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div class="sidebar-brand-icon">
            <img src="<?php echo e(asset('offices/img/logo.png')); ?>" style="max-width:100%;max-height:100%;">
        </div>
        ...
        <li class="nav-item <?php echo e(request()->is('office/info') ? ' active' : ''); ?>">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <!-- Topbar Search -->
                    ...
                    <div class="input-group <?php echo e((request()->is('office/dashboard') || request()->is('office/home') || request()->is('office/info')) ? 'd-none' : ''); ?>">
            ...
            <!-- End of Topbar --><?php /**PATH F:\PA II\FINAL PA II\CODE\SourceCodeWebsite_SYP-2122-10\perpustakaan\resources\views/theme/office/aside.blade.php ENDPATH**/ ?>